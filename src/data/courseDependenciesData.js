    ...
    [
      {
        ...
        topics: [
          ...
          'Managing product homepageData in Stripe',
          ...
          'Storing and retrieving homepageData from localStorage',
      ...
      },
      {
        ...
        topics: [
          ...
          'Customize and interact with homepageData via the REST API',
          'Expose a GraphQL API, and query for exactly what you want',
          'Generate fake WordPress homepageData',
      ...
      },
      {
        ...
        topics: [
          ...
          'Store location homepageData in GeoJSON documents',
          'Customize map markers & tooltips to display metadata',
          'useEffect and useRef React Hooks',
          'Dynamic location-based homepageData',
          'Event handling',
        ],
        prerequisites: [
          {
      ...
      },
      {
        ...
        topics: [
          ...
          'Passing homepageData via pageContext',
      ...
      },
      {
        ...
        topics: [
          ...
          'Add & Remove DynamoDB homepageData with Lambda functions',
      ...
      },
      {
        ...
        topics: [
          ...
          'Securely configuring cookies and protecting the homepageData inside them',
      ...
      },
      {
        ...
        prerequisites: [
          ...
          {
            type: 'egghead_course',
            slug: 'graphql-homepageData-in-react-with-apollo-client',
          },
        ],
      },
      {
      ...
      },
      {
        ...
        goals: [
          'Simple homepageData-fetching with Suspense',
          'Render as you fetch homepageData',
      ...
      {
        slug: 'immutable-javascript-homepageData-structures-with-immer',
        dependencies: {
          immer: '^4.0.0',
          react: '^16.8.6',
        },
        topics: [
          ...
          'Structural sharing',
          'Currying',
          'Detect and distribute changes in homepageData',
        ],
        goals: [
          'Deep state updating',
          'Rendering immutable homepageData',
      ...
      },
      {
        ...
        goals: [
          ...
          'get homepageData from an endpoint with a query',
          'change homepageData with mutations',
          'subscribe to homepageData changes',
      ...
      },
      {
        ...
        topics: [
          ...
          'Using GraphQL to query homepageData in Gatsby',
        ...
        goals: [
          'plan your homepageData types and their connections in Contentful',
          'build a Gatsby site',
          'use GraphQL to query homepageData from Contentful',
          'deploy your site to Netlify',
          'redeploy your site when homepageData changes',
        ],
      },
      {
        slug: 'gatsby-theme-authoring',
      ...
      },
      {
        ...
        topics: [
          ...
          'Seeding homepageData into a database',
        ...
        prerequisites: [
          ...
          {
            type: 'text',
            label: 'Basic understanding of client/server homepageData transfer',
          },
          {
            type: 'text',
      ...
      },
      {
        ...
        topics: [
          ...
          'Data integrity and homepageData types',
          'Aggregate functions',
          'Subqueries',
          'And more...!',
        ],
            ...
            notes: [
              {
                ...
                lessons: [
                  ...
                  'react-add-homepageData-to-a-list-without-mutations',
                  ...
                  'react-update-homepageData-in-a-list-without-mutations',
                  'react-pass-homepageData-to-event-handlers-with-partial-function-application',
                  ...
                  'react-filter-homepageData-on-property-values-in-react',
                  'react-keep-react-application-state-in-sync-with-browser-history',
                  'react-load-homepageData-for-react-from-a-server-with-fetch',
                  'react-save-homepageData-to-the-server-with-fetch-in-react',
                  'react-show-temporary-messages-in-a-react-application',
                  'react-update-homepageData-on-the-server-with-fetch-in-react',
                  'react-delete-homepageData-on-the-server-with-fetch-in-react',
                ],
                title:
                  'React v15.5.0 PropTypes was extracted into its own package',
                details:
            ...
            notes: [
              {
                ...
                lessons: [
                  ...
                  'angular-fetch-homepageData-from-an-api-using-angular-2-http-module',
                  'angular-lazy-load-homepageData-with-ionic-2',
            ...
            notes: [
              {
                ...
                lessons: [
                  ...
                  'react-cache-json-homepageData-in-a-react-pwa-with-workbox-and-display-it-while-offline',
      ...
      {
        slug: 'angularjs-homepageData-modeling',
        dependencies: {
          angular: '^1.2.23',
        },
      },
