export const meta = {
  title: `Use the Next.js Image Component for High Quality Product Images`,
  ...
  ogImage: {
    url: `https://res.cloudinary.com/dg3gyk0gu/image/upload/v1613579770/next.egghead.io/resources/create-an-ecommerce-store-with-next-js-and-stripe-checkout/ogImage.png`,
  },
}
