...
## Step 0: Setting up an application
...
![New Next.js app](https://res.cloudinary.com/dg3gyk0gu/image/upload/v1611015613/next.egghead.io/pages/learn/ecommerce/build-a-content-management-system-for-an-e-commerce-store-with-nextjs-and-sanity/Screen_Shot_2021-01-17_at_19.49.03.png)
...
## Step 1: Creating a new Sanity Studio project

To get started with Sanity, unless you use one of [their Starters](https://create.sanity.io/) which bootstraps an entire project complete with deployment, you need to use the terminal and npm to create a new project.
...
![Sanity Prompts](https://res.cloudinary.com/dg3gyk0gu/image/upload/v1611015879/next.egghead.io/pages/learn/ecommerce/build-a-content-management-system-for-an-e-commerce-store-with-nextjs-and-sanity/Screen_Shot_2021-01-17_at_10.27.58.png)

You can name the project anything you’d like, but it will be used as Sanity is setting up your project

For the dataset configuration, we can stick with the default for now, so you can answer Yes.

Finally, you can customize your output directory or let it use the default, which will create the project in the folder you’re in, based off of your project name.
...
![Setting up a new Sanity project in the terminal](https://res.cloudinary.com/dg3gyk0gu/image/upload/v1611015998/next.egghead.io/pages/learn/ecommerce/build-a-content-management-system-for-an-e-commerce-store-with-nextjs-and-sanity/Screen_Shot_2021-01-17_at_10.30.24.png)

We can even upload sample data into our project to make it easier to test this out.

![Choosing to upload sample data to Sanity](https://res.cloudinary.com/dg3gyk0gu/image/upload/v1611016106/next.egghead.io/pages/learn/ecommerce/build-a-content-management-system-for-an-e-commerce-store-with-nextjs-and-sanity/Screen_Shot_2021-01-17_at_10.31.52.png)

I’m going to select Yes so we can easily jump into sourcing the content into our application, but feel free to do this manually if you’d like with your own product selection.
...
![New Sanity account with sample products](https://res.cloudinary.com/dg3gyk0gu/image/upload/v1611016629/next.egghead.io/pages/learn/ecommerce/build-a-content-management-system-for-an-e-commerce-store-with-nextjs-and-sanity/Screen_Shot_2021-01-17_at_10.35.47.png)
...
![Successfully deployed Sanity Studio to the cloud](https://res.cloudinary.com/dg3gyk0gu/image/upload/v1611016670/next.egghead.io/pages/learn/ecommerce/build-a-content-management-system-for-an-e-commerce-store-with-nextjs-and-sanity/Screen_Shot_2021-01-17_at_10.39.12.png)
...
## Step 2: Installing Sanity Client in a Next.js app
...
## Step 3: Adding products to our Next.js homepage from a Sanity.io project
...
![Product data inside of the terminal](https://res.cloudinary.com/dg3gyk0gu/image/upload/v1611016750/next.egghead.io/pages/learn/ecommerce/build-a-content-management-system-for-an-e-commerce-store-with-nextjs-and-sanity/Screen_Shot_2021-01-17_at_17.55.28.png)
...
![Sanity products listed in the app](https://res.cloudinary.com/dg3gyk0gu/image/upload/v1611017355/next.egghead.io/pages/learn/ecommerce/build-a-content-management-system-for-an-e-commerce-store-with-nextjs-and-sanity/Screen_Shot_2021-01-17_at_20.20.48.png)
...
![A single, large product image loaded from Sanity](https://res.cloudinary.com/dg3gyk0gu/image/upload/v1611016834/next.egghead.io/pages/learn/ecommerce/build-a-content-management-system-for-an-e-commerce-store-with-nextjs-and-sanity/Screen_Shot_2021-01-17_at_21.41.10.png)
...
![Product images loaded from Sanity](https://res.cloudinary.com/dg3gyk0gu/image/upload/v1611016889/next.egghead.io/pages/learn/ecommerce/build-a-content-management-system-for-an-e-commerce-store-with-nextjs-and-sanity/Screen_Shot_2021-01-17_at_21.44.03.png)
...
![Multiple product images with a reduced size](https://res.cloudinary.com/dg3gyk0gu/image/upload/v1611016936/next.egghead.io/pages/learn/ecommerce/build-a-content-management-system-for-an-e-commerce-store-with-nextjs-and-sanity/Screen_Shot_2021-01-17_at_21.46.46.png)
