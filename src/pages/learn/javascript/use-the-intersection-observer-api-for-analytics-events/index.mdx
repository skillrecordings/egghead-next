export const meta = {
  ...
  coverImage: {
    url:
      'https://res.cloudinary.com/dg3gyk0gu/image/upload/v1612169697/egghead-next-ebombs/use-the-intersection-observer-api-for-analytics-events/3d-illustration.png',
    alt: '3D illustration with motion',
  },
  ogImage: {
    url: `https://res.cloudinary.com/dg3gyk0gu/image/upload/v1612169696/egghead-next-ebombs/use-the-intersection-observer-api-for-analytics-events/3d-illustration-ogImage.png`,
  },
}
