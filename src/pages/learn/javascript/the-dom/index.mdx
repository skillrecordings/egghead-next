...
<!-- Can we put in similar effect with the NodeType number on the nodes? -->

**[Insert same DOM Tree with the NodeType number and name next to HTML code]**

<QuestionReveal question="Create and label a DOM Tree, along with the corresponding Node Types">
...
Open up your own Developer Tools and inspect this paragraph.
