export const meta = {
  ...
  coverImage: {
    url:
      'https://res.cloudinary.com/dg3gyk0gu/image/upload/v1607909083/next.egghead.io/pages/learn/javascript/handling-copy-and-paste-in-cypress/copy-and-paste.png',
    alt: 'abstract illustration of copy and paste',
  },
  ogImage: {
    url: `https://res.cloudinary.com/dg3gyk0gu/image/upload/v1607909083/next.egghead.io/pages/learn/javascript/handling-copy-and-paste-in-cypress/copy-and-paste.png`,
  },
}
...
There is a way of firing real click events in Chrome, using [cypress-real-events](https://github.com/dmtrKovalenko/cypress-real-events) plugin. This plugin adds some real events to your app (hase a hover command too!). Firing a real event here will copy the desired text to the clipboard.
