export const meta = {
  ...
  ogImage: {
    url: `https://og-image-react-egghead.now.sh/article/Handling%20copy%20and%20paste%20in%20Cypress?bgImage=https://res.cloudinary.com/dg3gyk0gu/image/upload/v1607937544/next.egghead.io/pages/learn/javascript/handling-copy-and-paste-in-cypress/card.png&author=Filip%20Hric&state=draft`,
  },
}
