export const meta = {
  ...
  ogImage: {
    url: `https://og-image-react-egghead.now.sh/article/TailwindCSS%20Dark%20Mode%20in%20Next.js?author=Joel%20Hooks&dark=true&bgImage=https://res.cloudinary.com/dg3gyk0gu/image/upload/c_scale,h_906,w_1118/v1612660489/next.egghead.io/posts/Screen_Shot_2021-02-06_at_5.13.24_PM.jpg`,
  },
}
