...
1. Submit your article idea through [the form](/write-for-egghead#pitch-form)
2. We'll review your idea and email you if it aligns with our audience and goals
3. You write up an outline of the main points and sections
...
Fill out this form and we'll get in touch if we're interested.
...
<form className="max-w-md">
  ...
  ></textarea>
  <label for="draft" class="block text-sm leading-5 font-medium text-gray-700 mb-2">Introductory paragraph (~400 words)</label>
  <textarea
    id="draft"
    type="text"
    name="draft"
