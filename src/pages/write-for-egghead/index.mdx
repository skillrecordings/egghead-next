...
<form className="max-w-md">
  ...
  ></input>
  <label for="audience" class="block text-sm leading-5 font-medium text-gray-700 mb-2">Who is the article for? (skill level, prerequisites)</label>
  <input
    id="audience"
    type="text"
    name="audience"
    class="form-input block w-full pl-7 pr-12 sm:text-sm sm:leading-5 p-2  mb-4 border rounded border-gray-300 bg-gray-50" placeholder="intermediate React devs who want to improve their CSS"
  ></input>
  <label for="draft" class="block text-sm leading-5 font-medium text-gray-700 mb-2">Excerpt or introductory paragraph (~300 words)</label>
  <textarea
    id="draft"
    type="text"
    name="draft"
  ...
  <label for="relationships" class="block text-sm leading-5 font-medium text-gray-700 mb-2">Do you have professional relationships with any services, tools, or frameworks mentioned in the article? (ie. employee or developer advocate)</label>
<fieldset class="mt-2 flex flex-row">
  <div class="mt-2 flex items-center mr-4">
    <input id="relationships-yes" name="relationships" type="radio" class="form-radio h-4 w-4 text-indigo-600 transition duration-150 ease-in-out"></input>
    <label for="relationships-yes" class="ml-3">
      <span class="block text-sm leading-5 font-medium text-gray-700">Yes</span>
    </label>
  </div>
  <div class="mt-2 flex items-center">
    <input id="relationships-no" name="relationships" type="radio" class="form-radio h-4 w-4 text-indigo-600 transition duration-150 ease-in-out"></input>
