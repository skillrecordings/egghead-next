...
const Confirm: React.FunctionComponent = () => {
  ...
  return (
    <div className="flex-grow h-full w-full flex flex-col items-center justify-center text-center sm:py-48 py-24">
      <div className="max-w-2xl flex flex-col items-center">
        <NotificationIcon />
        <h1 className="text-2xl font-semibold py-4">Email sent</h1>
