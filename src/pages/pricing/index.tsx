...
const Pricing: FunctionComponent<PricingProps> = ({redirectURL}) => {
  ...
  const onClickCheckout = async (event: SyntheticEvent) => {
    ...
    if (emailIsValid(viewer?.email)) {
      ...
      router.push(`/pricing/email?priceId=${annualPrice.price_id}`)
    }
  }
  return (
    <>
      <div className="">
        <div className="pt-12 sm:pt-16 lg:pt-20 dark:text-gray-100">
          <div className="max-w-screen-xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center">
              <h2 className="text-3xl leading-9 font-extrabold  dark:text-gray-100 text-gray-900 sm:text-4xl sm:leading-10 lg:text-5xl lg:leading-none">
                Your egghead membership pays for itself.
              </h2>
              <h3 className="text-2xl leading-9 font-extrabold dark:text-gray-100 text-gray-900 sm:text-3xl sm:leading-10 lg:text-4xl lg:leading-none">
                Over and over again.
              </h3>
              <p className="max-w-3xl m-auto mt-4 text-center text-xl leading-7 dark:text-gray-300 text-gray-600">
                Build your professional developer portfolio and learn the skills
                you need to climb the career ladder as a badass web developer
              </p>
            </div>
          </div>
        </div>
        ...
        <SelectPlan>
          <div className="py-8 px-6 text-center dark:bg-gray-800 bg-gray-50 lg:flex-shrink-0 lg:flex lg:flex-col lg:justify-center lg:p-12">
            {!viewer?.is_pro && !viewer?.is_instructor && (
              <>
                ...
                <div className="mt-4 flex items-center justify-center text-3xl md:text-5xl leading-none font-extrabold text-gray-900 dark:text-gray-100">
                  ...
                  <span className="ml-3 dark:text-gray-100 text-base leading-7 font-medium dark:text-gray-100 text-gray-500">
                    USD
                  </span>
                </div>
              </>
                ...
                <button
                  ...
                  className={`${
                    pricesLoading || viewer?.is_pro || viewer?.is_instructor
                      ? 'opacity-40'
                      : 'opacity-100'
                  } w-full flex items-center justify-center px-5 py-10 border border-transparent text-base leading-6 font-medium rounded-md text-white dark:bg-gray-900  bg-gray-900 hover:bg-gray-800 focus:outline-none focus:shadow-outline transition duration-150 ease-in-out`}
                >
