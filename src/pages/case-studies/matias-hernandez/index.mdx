export const meta = {
  ...
  ogImage: {
    url: `https://res.cloudinary.com/dg3gyk0gu/image/upload/v1615923341/egghead-next-pages/instructors/Mati%CC%81as_Herna%CC%81ndez-og-image.png`,
  },
  contributors: [{name: 'Meg Cumby'}, {name: 'Zac Jones'}],
}
