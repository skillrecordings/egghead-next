...
const Custom500Page: React.FC = () => {
  return (
    <>
      <Header />
      <Main>
        <div className="flex flex-col md:flex-row items-center justify-center space-y-10 md:space-y-0 md:space-x-10 px-5 py-16">
          ...
          <div className="flex flex-col max-w-md">
            ...
            <p className="mb-6 text-lg">
              ...
              fault at all. We're already looking into it, but if you give us
              details about what happened, we can fix it faster.
            </p>
