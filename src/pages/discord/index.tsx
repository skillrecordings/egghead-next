        ...
        {process.env.NEXT_PUBLIC_DISCORD_AUTHORIZE && (
          <div className="grid place-items-center h-96">
            <p className="prose lg:prose-xl text-white text-center">
              This will authorize egghead to see your Discord identity and
              email. If you are currently logged in and a PRO member of egghead
              you will be invited added to the egghead Discord server as a
              member. If you aren't a PRO member, you will still be added to the
              server.
            </p>
