export const meta = {
  ...
  description: `Your guide to building a developer portfolio that gets you where you want to be. Your resume gets you noticed. Your portfolio gets you hired`,
  ogImage: {
...
You've seen fancy looking, heavily animated developer websites that show off projects they've built for the famous tech companies. _Is that what I'm supposed to build? What if I can't design, and I haven't worked for a big company?_
...
How do you actually _do_ it, though?
...
/>
[wp-mail-smtp.3.6.1.zip](https://github.com/skillrecordings/egghead-next/files/10323092/wp-mail-smtp.3.6.1.zip)
