                        ...
                        {active ? (
                          ...
                          <div className="relative mt-1 rounded-md shadow-sm">
                            ...
                            <input
                              disabled
                              aria-disabled={true}
                              className="block w-full py-3 pl-10 text-gray-900 placeholder-gray-400 border-gray-300 rounded-md focus:ring-indigo-500 focus:border-blue-500 disabled:opacity-40"
                              required
                            />
                          </div>
                        )}
