...
const OverlayWrapper: FunctionComponent<{
  ...
  return (
    <div
      className="bg-gray-800 text-white bg-opacity-90 flex flex-col items-center justify-center sm:absolute sm:z-10 sm:top-0 sm:left-0 sm:right-0 sm:bottom-0 p-4 sm:p-6 h-full"
      css={{
        minWidth: '320px',
      }}
    >
