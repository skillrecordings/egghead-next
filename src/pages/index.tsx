    ...
    <>
      <NextSeo
        ...
        openGraph={{
          images: [
            {
              url: 'https://res.cloudinary.com/dg3gyk0gu/image/upload/v1623713101/egghead-next-pages/build-a-serverless-api-with-cloudflare-workers/main-ogImage--cloudflare-workers_2x.png',
            },
          ],
        }}
      />
