...
import ReferenceMarkdown, {
  InlineMarkdown,
} from '@/components/workshop/software-factory/power-user-reference/reference-markdown'
import InlineSources from '@/components/workshop/software-factory/power-user-reference/inline-sources'
import Keyframes from '@/components/workshop/software-factory/power-user-reference/keyframes'
import {
  HERO,
  REFERENCE_MATERIALS,
