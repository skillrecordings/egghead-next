...
import ReferenceMarkdown from '@/components/workshop/codex/power-user-reference/reference-markdown'
import {
  REFERENCE_DOCS,
  SOURCE_EXCERPTS,
...
export default function ReferenceDocPage({
  ...
  const sourceMd = `/workshop/codex/power-user-reference/source/${slug}`
          ...
          <main className="bg-white dark:bg-gray-900">
            <div className="mx-auto max-w-3xl px-5 py-12 sm:py-16">
              <div className="flex flex-wrap items-center justify-between gap-3">
                ...
                >
                  ← Power User Workshop Reference Packet
                </Link>
                <a
                  href={sourceMd}
                  target="_blank"
