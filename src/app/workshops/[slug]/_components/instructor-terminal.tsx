...
interface InstructorTerminalProps {
  name?: string
  role?: string
  image?: string
  bio?: string
...
export default function InstructorTerminal({
  name = 'John Lindquist',
  role = 'Founder @ egghead.io',
  image = 'https://res.cloudinary.com/dg3gyk0gu/image/upload/v1683164538/assets/john.webp',
  bio = 'John Lindquist is your guide through the complexities of AI-driven development. As the founder of egghead.io, he has helped tens of thousands of developers navigate new technologies with clarity and confidence.',
  command = 'whoami',
}: InstructorTerminalProps) {
  return (
