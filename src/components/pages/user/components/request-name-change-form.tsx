...
const RequestNameChangeForm: React.FunctionComponent<RequestEmailChangeFormProps> =
  ({originalEmail}) => {
          ...
          return (
            <form className="grow" onSubmit={handleSubmit}>
              <div className="flex flex-col">
                <div className="text-sm mb-2 text-gray-600 dark:text-gray-200 empty:hidden">
                  {state.matches('edit') && (
                    <p>
                ...
                <div className="flex flex-col sm:flex-row space-y-2 sm:space-y-0 sm:space-x-2">
                  <input
                    ...
                    type="email"
                    value={
                      // state.matches('edit') ? values.email : originalEmail
                      'preferred name'
                    }
...
export default RequestNameChangeForm
