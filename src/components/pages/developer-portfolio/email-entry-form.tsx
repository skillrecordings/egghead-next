...
const DeveloperPortfolioEmailEntryForm: React.FC = () => {
  ...
  const onSubmit = async (values: any) => {
    ...
    cioIdentify(id, {
      ...
      developer_portfolio: 'yes',
    })
    track('submitted email cta', {
      location: 'developer-portfolio',
      email,
    })
  }
  ...
  return (
    <div className="flex flex-col items-center p-16 my-16 bg-gray-100 dark:bg-gray-800 rounded-lg">
      <EmailForm
        ...
        button="I'm Ready to Build my Portfolio"
        onSubmit={onSubmit}
      >
        <div className="text-center">
          <h1 className="font-normal text-black dark:text-white text-2xl tracking-tight font-light text-center max-w-xl mx-auto">
...
export default DeveloperPortfolioEmailEntryForm
