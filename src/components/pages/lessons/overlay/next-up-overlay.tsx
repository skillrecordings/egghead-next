...
const NextUpOverlay: React.FunctionComponent<{
  ...
  return (
    <>
      ...
      <div className="mt-4 md:mt-6">Up Next</div>
      <h3 className="text-md md:text-lg lg:text-lg font-semibold mt-4 text-center">
      ...
      <div className="mt-8 text-xs md:mt-12 lg:mt-12">
        Feeling stuck?{' '}
        <a
          onClick={() => {
