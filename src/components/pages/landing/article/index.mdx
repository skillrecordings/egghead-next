...
<H3 className="max-w-lg">Don't you wish you could jack into the Matrix and inject React directly to your brain?</H3>
<Prose>
...
<H3>egghead will turn you into a badass web developer. Learn any time, any place, at your own pace.</H3>
<Prose>
...
<Spacer/>
<List
  title={<strong className="block font-medium pb-3">When you join egghead you'll get:</strong>}
