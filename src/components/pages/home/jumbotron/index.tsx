...
const Jumbotron: FunctionComponent<JumbotronProps> = ({resource}) => {
  ...
  return (
    <div
      className="md:-mt-5 relative flex items-center justify-center bg-gray-900 text-white overflow-hidden rounded-b-lg md:rounded-t-none rounded-t-lg shadow-sm mb-4"
      css={{
        [bpMinMD]: {
          minHeight: 477,
        },
