...
import {CardVerticalLarge} from 'components/pages/home/card/card-vertical'
    ...
    <div className="max-w-screen-xl mx-auto bg-gray-50 p-5 dark:bg-gray-700">
      <FeaturedSectionSimple title="Staff Favourites">
        ...
        <div className="grid grid-cols-3 gap-4">
          <CardVerticalLarge
            key={projectFeatureCardVideoApp.path}
            data={projectFeatureCardVideoApp}
          />
          <CardVerticalLarge
            key={wordpressWithGraphql.path}
            data={wordpressWithGraphql}
          />
          <CardVerticalLarge
            key={projectFeatureCardVideoApp.path}
            data={projectFeatureCardVideoApp}
