...
const ResourceLink = ({url, children}) => {
  return (
    <div class="bg-white shadow border-gray-100 border-2 sm:rounded-lg">
      <div class="px-4 py-5 sm:p-6">
        <div class="sm:flex sm:items-start sm:justify-between">
          <div>
            <p class="mt-0 max-w-xl text-base leading-none text-gray-500">
              Recommended Resource
            </p>
            <a
              href={url}
              class="text-2xl leading-6 font-medium text-gray-900 mt-0 flex-start"
            >
              {children}
            </a>
          </div>
