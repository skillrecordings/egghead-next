      ...
      <div className="relative mx-auto max-w-2xl px-5">
        ...
        >
          ...
          <p className="mx-auto mt-4 max-w-xl text-center text-lg leading-relaxed text-gray-600 dark:text-gray-400 sm:text-xl">
            ...
            separate Codex power users from everyone else. Drop your email and
            we'll let you know when the next workshop opens.
          </p>
          <div className="mt-8">
            <GenericNewsletterSignupForm
              submitButtonText="Reserve your spot"
              successMessage="Thank you for signing up! We'll notify you when the Codex workshop is available."
              emailPlaceholder="Enter your email"
              namePlaceholder="Your name"
              newsletterKey="codex_workshop"
              trackingSource="codex_workshop_page"
              showNameField={true}
