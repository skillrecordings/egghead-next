export default function Logo() {
  return (
    <div
      className="mb-5 sm:mx-0 sm:px-0 px-2 font-mono text-[#2D3748] dark:text-[#ce6246]  leading-tight w-full"
      role="img"
      aria-label="Claude Code Workshop ASCII Art Logo"
      aria-hidden="true"
    >
      <div className="flex flex-col gap-2 bg-white dark:bg-[#111110] shadow-[0_0_20px_rgba(255,255,255,0.5)] dark:shadow-black rounded-lg justify-center items-center w-full ">
        <div className="w-full bg-[#4A5568] dark:bg-[#2f2f2c] h-8 flex items-center pl-2 gap-1 rounded-t-lg">
