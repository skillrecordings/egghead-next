...
const HorizontalResourceCard: React.FC<{
  ...
  const defaultClassName =
    'rounded-md aspect-w-4 aspect-h-2 w-full h-full transition-all ease-in-out duration-200 relative overflow-hidden group dark:bg-gray-800 bg-white dark:bg-opacity-60 shadow-smooth dark:hover:bg-gray-700 dark:hover:bg-opacity-50 overflow-hidden'
  return (
    <ResourceLink
