<div className="w-64"><img src="/images/eggo.svg" /></div>
...
egghead offers nearly **4300 video lessons** in total. Most are between 3 and 7 minutes long — short, sweet, and to the point. Many of them are standalone, so you can learn something new in no time at all.

We also offer *415+ courses*, with more coming all the time. That's multiple lessons with a narrative that takes you from beginning to end, including all the code you need to complete the project.
...
- 415+ full video courses
- nearly 4300 video lessons total
